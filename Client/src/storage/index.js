...
import { DocumentRiseQualificationApi }  from './services/DocumentRiseQualificationApi.js';
...
export default configureStore({
  reducer: {
    ...
    [DocumentRiseQualificationApi.reducerPath]: DocumentRiseQualificationApi.reducer,
  ...
  middleware: (
    ...
    .concat(DocumentRiseQualificationApi.middleware)
