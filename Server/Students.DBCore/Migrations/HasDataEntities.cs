...
internal static class HasDataEntities
{
    ...
    public static List<Person> PersonEntities => new(_personsEntities);
    ...
    private static readonly List<Person> _personsEntities = new()
    {
        new Person()
        {
    ...
    private static readonly List<Student> _studentEntities = new()
    {
        new Student
        {
            ...
            DateTakeDiplom = new DateTime(2024, 9, 1, 0, 0, 0, DateTimeKind.Utc),
        },
        new Student
        {
            Id = new Guid("ce523bbd-dbd2-4bc6-8986-0f0c83926c57"),
