...
public static class Mapper
{
  ...
  public static async Task<Students.Models.Student> WebhookToStudent(RequestWebhook form,
  ...
  /// <returns>Студент.</returns>
  public static async Task<Students.Models.Student> RequestDTOToStudent(RequestsDTO form)
  {
    return new Students.Models.Student
    {
      Family = form.family!,
